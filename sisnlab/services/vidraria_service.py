...
def cadastrar_vidraria(vidraria):
    Vidraria.objects.create(nome=vidraria.nome, marca=vidraria.marca, data_compra=vidraria.data_compra, 
            ...
            estante=vidraria.estante, prateleira=vidraria.prateleira, gaveta=vidraria.gaveta, obs=vidraria.obs)
