...
def cadastrar_aulapratica(aulapratica):
    ...
    data_inicio=aulapratica.data_inicio, data_fim=aulapratica.data_fim, quantalunos=aulapratica.quantalunos,
    obs=aulapratica.obs, status=aulapratica.status)    
...
def editar_aulapratica(aulapratica, aulapratica_novo):
    ...
    aulapratica.data_fim = aulapratica_novo.data_fim     
