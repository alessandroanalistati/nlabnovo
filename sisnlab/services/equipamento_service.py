...
def cadastrar_equipamento(equipamento):
    Equipamento.objects.create(nome=equipamento.nome, tombo=equipamento.tombo, marca=equipamento.marca, data_compra=equipamento.data_compra, 
            ...
            estante=equipamento.estante, prateleira=equipamento.prateleira, gaveta=equipamento.gaveta, obs=equipamento.obs)
