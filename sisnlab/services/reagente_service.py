...
def cadastrar_reagente(reagente):
    Reagente.objects.create(nome=reagente.nome, formula_q=reagente.formula_q, grau_p=reagente.grau_p, unidade=reagente.unidade, 
    ...
    gaveta=reagente.gaveta, obs=reagente.obs)
