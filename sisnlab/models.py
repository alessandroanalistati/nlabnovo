...
class Solucao(models.Model):
    ...
    foto = models.ImageField(upload_to='images', null=True, blank=True, verbose_name="Foto_Solução") 
...
class ItensAulaPratica(models.Model): 
    ...
    quant_equipamento = models.DecimalField(max_digits=9, decimal_places=2, default=0.00, null=True, blank=True, verbose_name='Quant_Aula_Pratica_Equipamentos' )
