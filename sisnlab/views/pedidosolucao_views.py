...
def inserir_pedidosolucao(request):
    if request.method == "POST":
        ...
        if form_pedidosolucao.is_valid():            
            ...
            estoque = form_pedidosolucao.cleaned_data["estoque"]
...
def itens_pedidosolucoes(request, pedidosolucao_id ):
    ...
    if request.method == "POST":               
        ...
        if form_itenspedidosolucao.is_valid():            
            ...
            unidade = form_itenspedidosolucao.cleaned_data["unidade"]                   
            quantidade = form_itenspedidosolucao.cleaned_data["quantidade"]              

        itenspedidosolucao_novo = itenspedidosolucao.ItensPedidoSolucao(usuario=request.user, pedidosolucao_id=pedidosolucao.id, reagente=reagente, unidade=unidade, 
