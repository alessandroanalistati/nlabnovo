...
def inserir_diverso(request):
    if request.method == "POST":
        ...
        if form_diverso.is_valid():
            ...
            origem = form_diverso.cleaned_data["origem"]           
            ...
            imagem = form_diverso.cleaned_data["imagem"]          
            obs = form_diverso.cleaned_data["obs"]           

            diverso_novo = diverso.Diverso(nome=nome, marca=marca, unidade=unidade, quantidade=quantidade, origem=origem, 
            ficha_tec=ficha_tec, sala=sala, armario=armario, bancada=bancada, estante=estante, prateleira=prateleira, gaveta=gaveta,
            imagem=imagem, obs=obs)
