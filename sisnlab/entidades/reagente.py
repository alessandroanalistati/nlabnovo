class Reagente():
    def __init__(self, nome, formula_q, grau_p, unidade, marca, quantidade, data_validade, controle_pfex, ficha_tec, massamolecular,
     densidade, disponibilidade, sala, armario, bancada, estante, prateleira, gaveta, obs):
        self.__nome = nome
